...
def main():
    ...
    while quit is False:
        ...
        if len(recorder.attention)>0:
            ...
            pygame.draw.circle(window, greenColor, (800,200), 30,1)
            pygame.draw.circle(window, greenColor, (800,200), 50,1)
            window.blit(attention_img, (760,260))
            pygame.draw.circle(window, redColor, (700,200), int(recorder.meditation[-1]/2))
            pygame.draw.circle(window, greenColor, (700,200), 30, 1)
            pygame.draw.circle(window, greenColor, (700,200), 50, 1)
